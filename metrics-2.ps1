...
# Write-Host "`n═════════════════ 2. USER TREND (Daily Active Users) ═════════════════" -ForegroundColor White -BackgroundColor DarkBlue
...
#Write-Host " ============ INFRASTRUCTURE HEALTH (CPU, Memory, Disk, Network) ============" -ForegroundColor White -BackgroundColor DarkBlue
...
try {
    ...
    #Write-Host "✅ Query executed successfully. Displaying results:" -ForegroundColor Green
    Write-Host "Fetching current CPU usage..." -ForegroundColor Green
